...
MQL4Parser.prototype.expression = function(_p) {
    ...
    try {
        ...
        case 13:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MQL4Parser.T__3) | (1 << MQL4Parser.T__19) | (1 << MQL4Parser.T__20) | (1 << MQL4Parser.T__21))) !== 0) || ((((_la - 33)) & ~0x1f) == 0 && ((1 << (_la - 33)) & ((1 << (MQL4Parser.T__32 - 33)) | (1 << (MQL4Parser.T__33 - 33)) | (1 << (MQL4Parser.T__55 - 33)) | (1 << (MQL4Parser.Null - 33)) | (1 << (MQL4Parser.Bool - 33)) | (1 << (MQL4Parser.Number - 33)) | (1 << (MQL4Parser.Identifier - 33)) | (1 << (MQL4Parser.String - 33)) | (1 << (MQL4Parser.Date - 33)))) !== 0)) {
                this.state = 264;
                this.expression(0);
                this.state = 266;
                _la = this._input.LA(1);
