...
// Ma constant
double MA2_bc=iMA(NULL,0,Ma2Period,Ma2Shift,0,4,0);
double MA2_bp=iMA(NULL,0,Ma2Period,Ma2Shift,0,4,1);
double MA2_bl=iMA(NULL,0,Ma2Period,Ma2Shift,0,4,2);
//-------------------------------------------------------------------+
//Check open orders
//-------------------------------------------------------------------+
if(OrdersTotal()>0){
...
if ((MA1_bc>MA2_bc)&&(MA1_bp>MA2_bp)&&(MA1_bl<MA2_bl)) //Signal Buy
 {
   int openbuy=OrderSend(Symbol(),OP_BUY,Lots,Ask,Slippage,slb,tpb,"Xbug_CE order ",MagicNumber,0,Blue);
 ...
 {
   int opensell=OrderSend(Symbol(),OP_SELL,Lots,Bid,Slippage,sls,tps,"Xbug_CE order ",MagicNumber,0,Green);
