...
//                   Molanis Strategy Builder 3.2 
//                       http://www.molanis.com                      
//                    
// THIS EA CODE HAS BEEN GENERATED USING MOLANIS STRATEGY BUILDER 3.2
// on Sat Sep 06 15:41:58 WAT 2014 
...
//Strategy Comments
#property copyright "Copyright © 2009-2011, Created with Molanis V 3.2 "
...
// General Variables
extern string    EAName="RobotiADXProfit";                     // Expert Advisor Name
...
extern int       TradingTimeStart = 0;               // i.e 9 = 9 am
...
extern int     LotManagementType = 1;                // 1 - Uses Decrease factor
...
extern bool    UseMartingale = false;   // Turns martingale  
extern double  MartingaleMultiplier = 2.0;        // i.e 2 = double next lot size
double  MaxMartingaleSize = 1.8;        // i.e 5 = max lot size is 5
...
extern double S_Symbol_LS_0 = 0.1;     //Used to change value or backtest Lot Size
...
extern double S_Symbol_TS_0 = 30;     //Used to change value or backtest Trailing Stop
extern double B_Symbol_LS_0 = 0.1;     //Used to change value or backtest Lot Size
...
extern double B_Symbol_TS_0 = 30;     //Used to change value or backtest Trailing Stop
...
// Check account type and mode
   Print("M-*** EA created with Molanis Strategy Builder 3.2 *** ");  
...
int start()
{
if (StrToTime("2014.09.16")+259200 < TimeCurrent() ) {
Print("Your demo license expired. Please contact us or buy a license from molanis.com/store.");
Comment("Your demo license expired. Please contact us or buy a license from molanis.com/store.");
Alert("Your demo license expired. Please contact us or buy a license from molanis.com/store.");return; }
//----start start
AutoAdjustSLTP = false;
//Prepare coments
string mycomment;
mycomment="THIS EA HAS BEEN GENERATED USING MOLANIS STRATEGY BUILDER 3.2 -";
 if (TradeOrAlert) {
...
// Define string for email   
 if (SendMailMode) {
   ...
   mailstring = "email generated by Molanis Strategy Builder v3.2 \n";
...
// Check conditions
if (  ( iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_MINUSDI,0)>iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_PLUSDI,0) )  ) 
   {  SELL(Symbol(),S_Symbol_LS_0,S_Symbol_TP_0,S_Symbol_SL_0,S_Symbol_TS_0,"if (  ( iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_MINUSDI,0)>iADX(Symbol(),PERIOD_H1,14,PRICE_C...") ;}
if (  ( iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_PLUSDI,0)>iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_MINUSDI,0) )  ) 
   {  BUY(Symbol(),B_Symbol_LS_0,B_Symbol_TP_0,B_Symbol_SL_0,B_Symbol_TS_0,"if (  ( iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_PLUSDI,0)>iADX(Symbol(),PERIOD_H1,14,PRICE_CL...") ;}
...
// Alerts
if (  ( iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_MINUSDI,0)>iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_PLUSDI,0) )  ) 
   { MolanisAlert("if (  ( iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_MINUSDI,0)>iADX(Symbol(),PERIOD_H1,14,PRICE_CLO...","SELL(Symbol(),0.1,0,0,30)",Symbol()) ;}
if (  ( iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_PLUSDI,0)>iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_MINUSDI,0) )  ) 
   { MolanisAlert("if (  ( iADX(Symbol(),PERIOD_H1,14,PRICE_CLOSE,MODE_PLUSDI,0)>iADX(Symbol(),PERIOD_H1,14,PRICE_CLOS...","BUY(Symbol(),0.1,0,0,30)",Symbol()) ;}
...
/*
*** Generated with Molanis Strategy Builder 3.2 ***
*** www.molanis.com ***
*** Released 2010-02-20 ***
*/
