...
extern double CCILevel3=-50;
extern double CCILevel4=-190;
int start()
  {
//----
  int i,ordini;
  ...
  if ((ordini==0)&&(TimeMinute(MarketInfo(Symbol(),MODE_TIME))==00))
  {
      ...
      if (iCCI(NULL, NULL,14,PRICE_TYPICAL,0)<CCILevel3)
      if (iCCI(NULL, NULL,14,PRICE_TYPICAL,0)>CCILevel4)
      if (Open[1]>Close[1])
      {
         {
            OrderSend(Symbol(),OP_SELL,Lots,Bid,3,0,0,NULL,MagicNumber,0,Blue);
         }
      }
  }
  else
