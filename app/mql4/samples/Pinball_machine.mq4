...
extern double Lots          = 0.3;          // Размер лота
 bool   MarketWatch   = false;         // Запросы под исполнение "Market Watch".
 int    MagicNumber   = 28081975;     // Магическое число ордеров
...
//----
   ...
   int    StopLoss      = GetRand(100,1000);          // Размер стопа в пунктах
   int    TakeProfit    = GetRand(100,1000);          // Размер тейка в пунктах
