...
extern double Lots              = 0.01; // you can change the lot but be aware of margin. Its better to trade with 1/4 of your capital. 
extern double MaxLots=4;
extern double StopLoss          = 210;  // Maximum pips willing to lose per position.


extern int TakeProfit           = 18;   // Maximum profit level achieved. recomended  no more than 20
extern double MarginCutoff      = 300;  // Expert will stop trading if equity level decreases to that level.
extern int Slippage             = 40;   // Possible fix for not getting closed Could be higher with some brokers    
//----
int cnt, ticket;
