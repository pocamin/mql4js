...
sig_buy=iCustom(NULL,0,"_3 MA Cross w_Alert v2",FasterMA,FasterShift,FasterMode,MediumMA,MediumShift,MediumMode,SlowerMA,SlowerShift,SlowerMode,SoundAlert,0,TradeBar);
sig_sell=iCustom(NULL,0,"_3 MA Cross w_Alert v2",FasterMA,FasterShift,FasterMode,MediumMA,MediumShift,MediumMode,SlowerMA,SlowerShift,SlowerMode,SoundAlert,1,TradeBar);


ch_up=iCustom(NULL,0,"Price Channel",ChannelPeriod,Shift,0,TradeBar);
ch_dn=iCustom(NULL,0,"Price Channel",ChannelPeriod,Shift,0,TradeBar);
...
if ((CheckAddPos() && CanAddPos && OpenPos<=MaxOpenOrders) || (OpenPos==0 && !CanAddPos)) {
	if (OpenSell==1 && AllowTrade==1) {
      ...
      if (AutoStopLoss) MyStopLoss=NormalizeDouble(ch_up,Digits);
      PlaySound("alert.wav");
	...
	if (OpenBuy==1 && AllowTrade==1) {
      ...
      if (AutoStopLoss) MyStopLoss=NormalizeDouble(ch_dn,Digits);
      PlaySound("alert.wav");
