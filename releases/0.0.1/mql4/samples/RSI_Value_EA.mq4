...
int start()
{
  ...
  {
     int result=0;
     if((iRSI(NULL,0,14,PRICE_CLOSE,2)<50)&&(iRSI(NULL,0,14,PRICE_CLOSE,1)>50)) // Here is your open buy rule
     {
     ...
     if((iRSI(NULL,0,14,PRICE_CLOSE,2)>50)&&(iRSI(NULL,0,14,PRICE_CLOSE,1)<50)) // Here is your open Sell rule
     {
  ...
  for(int cnt=0;cnt<OrdersTotal();cnt++)
     {
      ...
      if(OrderType()<=OP_SELL &&   
         ...
         )  
        {
         if(OrderType()==OP_BUY)  
           {
              if((iRSI(NULL,0,14,PRICE_CLOSE,2)>50)&&(iRSI(NULL,0,14,PRICE_CLOSE,1)<50)) //here is your close buy rule
              {
           ...
           {
                if((iRSI(NULL,0,14,PRICE_CLOSE,2)<50)&&(iRSI(NULL,0,14,PRICE_CLOSE,1)>50)) // here is your close sell rule
                {
                   OrderClose(OrderTicket(),OrderLots(),OrderClosePrice(),Slippage,Red);
                }
            if(TrailingStop>0)  
