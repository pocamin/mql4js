...
Обрабатываем паттерн продолжения тренда. Расширенная версия советника с адаптивными уровнями стоп лосса, тейкпрофита, 
...
Подробное описание параметров советника доступно в 18 номере журнала, 
